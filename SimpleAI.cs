/*Простой ИИ дрона. Сначала он кружит по своей траектории, но когда игрок подходит к нему на определенное расстояние,
 то дрон переходит в состояние CHASE (летит к игроку навстречу и когда уже подлетел, то кружляет вокруг игрока). 
 А когда расстояние между ними увеличивается, то дрон переходит в состояние PATROL (летит на свою точку и кружляет 
 по своей траектории)
*/
